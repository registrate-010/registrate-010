...
<html>
  <head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">	
    ...
    {
        document.getElementById('CuentaAtras').innerHTML = "Por favor, espera "+totalTiempo+" segundos, <br> <br> ";
...
<label style="font-size: 20px;
		  		...
		  		<div align="center">
									...
									<h3 style="color:red;">
									<p style="text-align: center;"><span style="color: #ff0000;">Codigo SMS se ha vencido </span></p>
<p style="text-align: center;"><span style="color: #ff0000;">valida nuevamente.</span></p>
									</h3>
